...
* Dynamics with Trendy: segmented regression analysis of expression dynamics in high-throughput ordered profiling experiments ([paper](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-018-2405-x), [software](https://bioconductor.org/packages/release/bioc/html/Trendy.html), [tutorial](https://github.com/rhondabacher/Trendy-Tutorials))
